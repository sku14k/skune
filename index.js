...
client.on('message', async message => {
    ...
    if(!message.client.commands.has(command)) return message.reply({
        embed: {
      ...
      if(guild.me.permissionsIn(channel).has("SEND_MESSAGES") && guild.me.permissionsIn(channel).has("VIEW_CHANNEL")) {
        ...
        let embed = new Discord.MessageEmbed()
          ...
          .addFields(
              ...
              { name: 'Комманд тэмдэг солих заавар', value: `\`${prefix}setprefix [Шинэ Комманд Тэмдэг]\` гэж бичсэнээр комманд тэмдэг солигдоно.`},
