...
module.exports = {
  ...
  async execute(message, args) {
    ...
    var datestring = `${user.joinedAt.getFullYear()} оны ${
      user.joinedAt.getMonth() + 1
    }-р сарын ${user.joinedAt.getDate()}-нд ${user.joinedAt.getHours()} цаг ${user.joinedAt.getMinutes()} минут`;
    var datestrung = `${user.user.createdAt.getFullYear()} оны ${
