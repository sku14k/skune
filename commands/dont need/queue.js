...
module.exports = {
  name: "queue",
  description:
    "Энэ комманд нь ямар ямар дуунууд хүлээлэгэнд байгааг харахад ашигладаг.",
...
function generateQueueEmbed(message, queue) {
  ...
  for (let i = 0; i < queue.length; i += 10) {
    ...
    const embed = new MessageEmbed()
      .setAuthor(
        "Серверт дараалалд байгаа дуунууд",
      ...
      .setFooter(
        "Серверийн дуу тоглуулагчийн дууны түвшин " + serverQueue.volume
      );
    if (serverQueue.songs.length === 1)
      embed.setDescription(`Дараа нь тоглох дуу алга.`);
